...
const StudentList = () => {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6">
      <h2 className="text-lg sm:text-2xl  lg:text-3xl  font-semibold mb-4 text-center mt-6 sm:mt-10 mb-5">Student List</h2>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between mb-4">
        ...
        <button
          ...
          className="ml-4 bg-deep-blue text-white px-4 py-2 rounded hover:bg-blue-700 flex items-center mt-4"
        >
